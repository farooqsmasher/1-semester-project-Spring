...
<link rel="stylesheet" href="uiresources/assets/css/ace.min.css" />
...
li a:hover {
 ...
 <ul>
  ...
  <li><a class="active" href="login">USER-LOGIN</a></li>
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-group blue"></i> <span
									style="color: #0099CC; font-weight: 600">USER LOGIN</span>
							</h1>
