...
<link rel="stylesheet" href="uiresources/assets/css/ace.min2.css" />
...
li a:hover {
 ...
 <ul>
  <li><a class="active" href="tpalogin">TPA LOGIN</a></li>
  <li><a href="serverlogin">SERVER-LOGIN</a></li>
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class=" icon-key blue"></i> <span
									style="color: #0099CC; font-weight: 600">TPA-LOGIN</span>
							</h1>
