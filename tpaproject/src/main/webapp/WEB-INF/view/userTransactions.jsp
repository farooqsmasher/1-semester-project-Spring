...
<body>
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">User Downloads</li>
					</ul>
					<!-- .breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							<div class="table-header">List Of All Downloads..</div>
									...
									<tbody>
										<c:forEach items="${filesList}" var="fileIte">
											<tr>
												...
												<td>${fileIte.file.description}</td>
												<td>${fileIte.file.name}</td>
												<td>${fileIte.downloadDate}</td>
	...
	<script type="text/javascript">
			...
			function sendKey(randomKey,secretKey,fileName,email){
			
			 $.ajax({url: "sendKey?randomKey="+randomKey+"&secretKey="+secretKey+"&fileName="+fileName+"&email="+email, success: function(result){
