...
<body>
									...
									<tbody>
										<c:forEach items="${filesList}" var="fileIte">
											<tr>
												...
												<td><a href="downloadFile?id=${fileIte.id}" target="_blank">view</a></td>
												<td><a href="ackFile?id=${fileIte.id}">Acknowledge File</a></td>
												<td><input id='${fileIte.id}' type="text" ><a href="#" onclick="auditFile('${fileIte.id}')">Audit</a></td>
	...
	<script type="text/javascript">
			...
			function auditFile(id){
			window.location="auditFile?id="+id+"&keywords="+document.getElementById(id).value;
			}
