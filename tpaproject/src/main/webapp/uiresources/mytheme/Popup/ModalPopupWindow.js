...
function ModalPopupWindow() {
    ...
    this.SetLoadingImagePath = function (imagePath) {
        document.getElementById("bailwal_img_overlay_loading").src = "<c:url value="/uiresources/Popup/loading.png"/>";
    }
    this.SetCloseButtonImagePath = function (imagePath) {
        document.getElementById("bailwal_img_overlay_close").src = "<c:url value="/uiresources/Popup/remove.png"/>";
    }
